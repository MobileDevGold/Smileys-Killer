...
static Resource middleResource =  { cocos2d::CCSizeMake(960 , 640) ,  "ipad"   };
static Resource fullResource =    { cocos2d::CCSizeMake(1136, 640) ,  "ipad"   };
static Resource mediumResource =  { cocos2d::CCSizeMake(1024, 768),  "ipad"   };
static Resource largeResource  =  { cocos2d::CCSizeMake(2048, 1536), "ipad" };
